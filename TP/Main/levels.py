...
#level 1 setup
def initLevel1(app):
	#rounds: list of waves; wave: color, number spawned, interval between spawn, pause after spawning
	app.rounds = [
		#round 1
		[("red", 5, 2, 5)],
		...
		#round 11
		[("blue", 20, 0.35, 2), ("green", 20, 0.7, 2), ("yellow", 5, 1.5, 7)],

		#round 12
		[("red", 30, 0.2, 1), ("blue", 30, 0.25, 1), ("green", 30, 0.5, 7)],

		#round 13
		[("yellow", 5, 0.5, 1), ("blue", 50, 0.15, 7)],
		...
		#round 16
		[("yellow", 20, 0.5, 1), ("blue", 100, 0.12, 10)],

		#round 17
		[("green", 30, 0.2, 1), ("pink", 5, 0.3, 10)],

		#round 18
		[("red", 30, 0.1, 0.1), ("yellow", 5, 0.2, 0.2), ("red", 30, 0.1, 0.1), ("green", 15, 0.15, 0.2), ("pink", 3, 0.5, 10)],
